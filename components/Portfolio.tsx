...
const projects = [
  ...
  { title: 'Model Edit Vol.3',  category: 'Reels Editing',    src: '/videos/model3.mp4',           thumb: '/thumbnails/model3.jpg',           duration: '0:30', banner: 'Clothing & Model Edits' },
  { title: 'Model Edit Vol.4',  category: 'Reels Editing',    src: '/videos/model4.mp4',           thumb: '/thumbnails/model4.jpg',           duration: '0:30', banner: 'Clothing & Model Edits' },
  ...
  { title: 'Khadi Saree',       category: 'Reels Editing',    src: '/videos/khadi_saree.mp4',      thumb: '/thumbnails/khadi_saree.jpg',      duration: '0:30', banner: 'Clothing & Model Edits' },
  { title: 'Dhavani',           category: 'Reels Editing',    src: '/videos/dhavani_final_00.mp4', thumb: '/thumbnails/dhavani_final_00.jpg', duration: '0:30', banner: 'Clothing & Model Edits' },
